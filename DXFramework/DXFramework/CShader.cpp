	...
	case EShaderType::VertexShader:
		{
			...
			if (hr != S_OK)
			{
				OutputShaderErrorMessage(errorBlob, m_pSysWindow->GetHandle(), L"shader_error_vs.txt");
				break;
			}
	...
	case EShaderType::PixelShader:
		{
			...
			if (hr != S_OK)
			{
				OutputShaderErrorMessage(errorBlob, m_pSysWindow->GetHandle(), L"shader_error_ps.txt");
				break;
			}
